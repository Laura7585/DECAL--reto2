...
public class fragment_buscar extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imagen1 = (ImageView) v.findViewById(R.id.image1_bus);
        imagen1.setImageDrawable(drawable1);

        button1 = (Button) v.findViewById(R.id.buttonComprar_bus);
        button2 = (Button) v.findViewById(R.id.button_info_bus);
        imageButton1 = (ImageButton) v.findViewById(R.id.imageButton_agreFav_bus);
        ...
        imageButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "Se agrega a favoritos", Toast.LENGTH_SHORT).show();
            }
        });
